...
print(perm)
# coral species, time, and the interaction of species and time are significant at 0.05 level

perm1<-adonis2(dist.clr~colony*timepoint,as(sample_data(ps_qf),"data.frame"))
print(perm1) 
# interaction of colony and time is significant at 0.05 level
...
print(perm3)
# time, controlling for colony is significant at 0.05 level
...
# Differential abundance of taxa with time, controlling for coral species
...
write.table(df, "DA-Families_time.txt", sep="\t",row.names = FALSE)
